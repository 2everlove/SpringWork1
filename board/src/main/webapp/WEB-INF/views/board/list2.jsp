					...
					<div class='pull-right'>
						<ul class="pagination">
							<c:if test="${pageMaker.prev}">
								<li class="paginate_button previous" onclick="javascript:page(${pageMaker.startPage - 1})"><a href="#">Previous</a></li>
							</c:if>
							...
							<%-- <c:choose>
								...
								<li class="paginate_button ${pageMaker.cri.pageNum == num ? "active":""}" onclick="javascript:page(${num})"><a href="#">${num}</a></li>
							</c:forEach>
							<c:if test="${pageMaker.next}">
								<li class="paginate_button next" onclick="javascript:page(${pageMaker.endPage + 1})"><a href="#">Next</a></li>
							</c:if>
						</ul>
					</div>
					<!-- end Pagination -->
